...
// 默认:
//   baseline = tests/baseline/phase1f_p2_complete.json (最新阶段 baseline)
...
//     → phase1f_p2_complete (1f-p2 +徐州 xiaopei/donghai +荆南 wuling +关陇 shangdang/anding, 53 cities, **当前默认**)
//
// 退出码:
//   0 = PASS(完全一致)
//   1 = FAIL(有 diff)
...
const BASELINE_DEFAULT = path.resolve(__dirname, 'baseline', 'phase1f_p2_complete.json');
