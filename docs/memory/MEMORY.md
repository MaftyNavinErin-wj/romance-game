...
- [Refactor phase status](project_refactor_status.md) — GEN_BASE audit 闭环 ✅ + **phase 6 wire W1-W3 ✅ push'd + W4a step-1 ✅ local** (`86843a3` GENS_FULL adapter); 下次 W4a step-2 (切 GEN_BASE+SCENARIO, byte-identical 故意破)。lesson: W-wire 必须全 G dump 实测 slice vs legacy verbatim;hidden state 坑 (isCapital key 集 / x/y / minTurn 全在 WILD_GENS 不在 GENS_FULL)
