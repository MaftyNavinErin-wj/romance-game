...
- [Refactor phase status](project_refactor_status.md) — **scenario system 1a + 1b-1 + 1b-2 完成 ✅** (main local 151cc6b, 12 commits 待 push). 下次 session: 阶段 1c hardcoded 214 cleanup (~321 grep matches, 3-4 session)
