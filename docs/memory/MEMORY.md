...
- [战斗机制 systematic bug fix sprint 候选](project_combat_mechanism_bugfix.md) — audit pass 2 S1-S6 完结 + §5.7 P3 fix close (1be7ff9); 终极结论: 全 src/ 异步唯一 fire-and-forget Promise = tick.js:632, §5.1+§5.3 孤立漏点; 留 §5.3/5.6/5.8/5.9 给后续
