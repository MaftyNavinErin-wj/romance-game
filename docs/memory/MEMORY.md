...
- [战斗机制 systematic bug fix sprint 候选](project_combat_mechanism_bugfix.md) — audit pass 2 S1-S6 + user 实机反馈; §5.7 P3 fix + Test 2 runtime 模拟 close; §5.10 phantom 时序 P2 真 bug 锁定 (user 实测); §5.3 降 P3
