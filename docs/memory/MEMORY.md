...
- [战斗机制 systematic bug fix sprint 候选](project_combat_mechanism_bugfix.md) — 批 1 §5.1+§5.2 close; audit pass 2 S1-S5 完结 (§5.3 真 bug + §5.6/5.7/5.8 P3-P6); 16 queue 总表 (15 robust + 1 stale 源 _pendingBattleAnimations), 跨 chain 三类 robust 模式
