...
- [战斗机制 systematic bug fix sprint 候选](project_combat_mechanism_bugfix.md) — 批 1 §5.1+§5.2 close; audit pass 2 S1 §5.3 真 bug + §5.4 verified; S2 §5.5 (6 字段 0 bug, robust by design); S3 候选 squad/_pendingBattleAnimations
