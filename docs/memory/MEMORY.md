...
- [战斗机制 systematic bug fix sprint 候选](project_combat_mechanism_bugfix.md) — 批 1 §5.1+§5.2 close; audit pass 2 S1-S5 + §5.7 P3 fix close (1be7ff9); §5.3 真 bug + §5.6/5.8 P3-P6 留下次; 16 queue 总表, 三类 robust 模式
