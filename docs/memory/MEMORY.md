...
- [Refactor phase status](project_refactor_status.md) — GEN_BASE 数据层 audit 闭环 ✅ + **phase 6 wire W1 ✅** (势力杂项 + 入口/叙事, commit `63b5490` 未 push); 下次 W2 (城市 CITIES_DEF → SCENARIO.cities)。lesson: W-wire 必须全 G dump 实测 slice vs legacy verbatim
