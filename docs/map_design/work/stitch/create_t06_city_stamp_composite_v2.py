...
OUT = ROOT / "terrain_t06_cc_w_no_city_v2_city_stamp_composite_v2.png"
PREVIEW = ROOT / "terrain_t06_cc_w_no_city_v2_city_stamp_composite_v2_preview.png"
...
def draw_review_overlay(img, placements):
    ...
    draw.text(
        (38, 32),
        "T06 v2 city stamp cutout composite v2 - review labels only, no runtime/map promotion",
...
def main():
    ...
    manifest_json = ROOT / "terrain_t06_cc_w_no_city_v2_city_stamp_composite_v2_placements.json"
