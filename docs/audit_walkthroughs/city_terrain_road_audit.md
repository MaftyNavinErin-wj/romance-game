...
- luoyang-guandu: river=6, hex=13, terrain={"plain":3,"hill":4,"river":6}
- bazhong-yiling: river=6, hex=12, terrain={"plain":3,"river":6,"mountain":3}
- donghai-xiapi: river=6, hex=11, terrain={"plain":5,"river":6}
- luoyang-xuchang: river=4, hex=15, terrain={"plain":8,"river":4,"hill":3}
- bazhong-chengdu: river=4, hex=8, terrain={"plain":4,"river":4}
- changsha-jiaozhou: river=3, hex=18, terrain={"plain":5,"river":3,"mountain":5,"forest":5}
- xuzhou-guangling: river=3, hex=17, terrain={"plain":12,"hill":2,"river":3}
- chaigang-yuzhang: river=3, hex=17, terrain={"plain":14,"river":3}
- changan-luoyang: river=3, hex=10, terrain={"plain":7,"river":3}
- lingling-changsha: river=3, hex=10, terrain={"plain":3,"mountain":4,"river":3}
- xiapi-shouchun: river=3, hex=10, terrain={"plain":4,"river":3,"hill":3}
- shangyong-hanzhong: river=3, hex=9, terrain={"plain":6,"river":3}
- puyang-qingzhou: river=3, hex=9, terrain={"plain":6,"river":3}
- beihai-guangling: river=2, hex=22, terrain={"plain":20,"river":2}
...
- shangyong-xiangyang: river=2, hex=12, terrain={"plain":8,"hill":2,"river":2}
- beiping-beihai: river=2, hex=10, terrain={"plain":5,"mountain":3,"river":2}
...
- jianning-jiaozhou: river=1, hex=28, terrain={"plain":8,"mountain":15,"forest":4,"river":1}
- jingkou-shouchun: river=1, hex=22, terrain={"plain":20,"river":1,"hill":1}
- hedong-tianshui: river=1, hex=16, terrain={"plain":11,"hill":4,"river":1}
- qingzhou-youzhou: river=1, hex=16, terrain={"plain":6,"river":1,"forest":5,"mountain":4}
- luoyang-nanyang: river=1, hex=14, terrain={"plain":10,"river":1,"mountain":3}

## Longest Roads
- jianning-jiaozhou: dist=255, hex=28, terrain={"plain":8,"mountain":15,"forest":4,"river":1}
...
- yongan: nearest=bazhong, dist=85px, hex=9
- langya: nearest=xiapi, dist=82px, hex=9
...
- bingzhou: nearest=shangdang, dist=58px, hex=6
...
- q31,r56: nearest=jiaozhou, dist=112px, terrain=mountain
- q86,r17: nearest=beihai, dist=104px, terrain=plain
- q93,r24: nearest=donghai, dist=102px, terrain=plain
- q87,r10: nearest=beihai, dist=100px, terrain=plain
- q75,r55: nearest=yuzhang, dist=99px, terrain=mountain
- q81,r44: nearest=suzhou, dist=99px, terrain=mountain
- q71,r58: nearest=yuzhang, dist=99px, terrain=plain
- q26,r55: nearest=jianning, dist=95px, terrain=plain
- q35,r53: nearest=jiaozhou, dist=95px, terrain=plain
...
|---|---:|---|---:|---:|---|---|
| anding / 安定 | 23,20 | plain->plain | 7/49 rough, 3/49 water | 3 | tianshui 55px | OK: center is passable and spacing/road checks are within thresholds. |
...
| beihai / 北海 | 76,12 | plain->plain | 0/49 rough, 11/49 water | 4 | langya 89px | OK: center is passable and spacing/road checks are within thresholds. |
...
| chenliu / 陈留 | 54,20 | plain->plain | 4/49 rough, 7/49 water | 5 | guandu 27px | CHANGED: moved east into the Chenliu/Kaifeng plain corridor north of Xuchang. |
| donghai / 东海 | 82,27 | plain->plain | 0/49 rough, 8/49 water | 3 | guangling 31px | OK: east/river lowland placement; bitmap darkness is ink/shore texture, not a data mountain enclosure. |
| guandu / 官渡 | 52,22 | plain->plain | 11/49 rough, 7/49 water | 4 | chenliu 27px | OK: center is passable and spacing/road checks are within thresholds. |
| guangling / 广陵 | 82,30 | plain->plain | 0/49 rough, 9/49 water | 5 | donghai 31px | OK: east/river lowland placement; bitmap darkness is ink/shore texture, not a data mountain enclosure. |
...
| hedong / 河东 | 34,18 | plain->plain | 0/49 rough, 5/49 water | 7 | shangdang 45px | OK: center is passable and spacing/road checks are within thresholds. |
| hefei / 合肥 | 64,29 | hill->plain | 27/49 rough, 4/49 water | 5 | shouchun 10px | OK: east/river lowland placement; bitmap darkness is ink/shore texture, not a data mountain enclosure. |
| huiji / 会稽 | 92,43 | forest->plain | 0/49 rough, 29/49 water | 1 | suzhou 45px | ACCEPTED: rough or river-adjacent region matches the real western/southern terrain band. |
...
| jianye / 建业 | 72,37 | plain->plain | 14/49 rough, 7/49 water | 4 | lujiang 58px | OK: east/river lowland placement; bitmap darkness is ink/shore texture, not a data mountain enclosure. |
| jiaozhou / 交州 | 43,59 | forest->plain | 6/49 rough, 5/49 water | 4 | lingling 78px | ACCEPTED: rough or river-adjacent region matches the real western/southern terrain band. |
| jingkou / 京口 | 84,34 | plain->plain | 0/49 rough, 3/49 water | 4 | guangling 45px | OK: east/river lowland placement; bitmap darkness is ink/shore texture, not a data mountain enclosure. |
| jingzhou / 江陵 | 47,40 | plain->plain | 2/49 rough, 6/49 water | 4 | wuchang 54px | OK: center is passable and spacing/road checks are within thresholds. |
| langya / 琅琊 | 75,20 | plain->plain | 0/49 rough, 8/49 water | 3 | xiapi 82px | OK: east/river lowland placement; bitmap darkness is ink/shore texture, not a data mountain enclosure. |
...
| lingling / 零陵 | 50,55 | plain->plain | 20/49 rough, 0/49 water | 4 | panyu 75px | ACCEPTED: rough or river-adjacent region matches the real western/southern terrain band. |
...
| luoyang / 洛阳 | 40,20 | plain->plain | 5/49 rough, 9/49 water | 7 | hedong 58px | OK: center is passable and spacing/road checks are within thresholds. |
...
| panyu / 番禺 | 52,62 | forest->plain | 22/49 rough, 3/49 water | 2 | lingling 75px | ACCEPTED: rough or river-adjacent region matches the real western/southern terrain band. |
...
| puyang / 濮阳 | 58,18 | plain->plain | 0/49 rough, 7/49 water | 3 | chenliu 42px | OK: center is passable and spacing/road checks are within thresholds. |
| qingzhou / 青州 | 66,16 | plain->plain | 0/49 rough, 9/49 water | 8 | bohai 55px | OK: center is passable and spacing/road checks are within thresholds. |
...
| shangyong / 上庸 | 34,34 | plain->plain | 11/49 rough, 7/49 water | 3 | yiling 55px | ACCEPTED: rough or river-adjacent region matches the real western/southern terrain band. |
| shouchun / 寿春 | 63,28 | hill->plain | 25/49 rough, 5/49 water | 5 | hefei 10px | OK: east/river lowland placement; bitmap darkness is ink/shore texture, not a data mountain enclosure. |
| suzhou / 吴郡 | 90,39 | plain->plain | 0/49 rough, 23/49 water | 2 | huiji 45px | ACCEPTED: rough or river-adjacent region matches the real western/southern terrain band. |
...
| wuchang / 武昌 | 53,40 | plain->plain | 0/49 rough, 10/49 water | 4 | jingzhou 54px | OK: center is passable and spacing/road checks are within thresholds. |
...
| xiapi / 下邳 | 72,28 | plain->plain | 1/49 rough, 6/49 water | 4 | xuzhou 58px | OK: east/river lowland placement; bitmap darkness is ink/shore texture, not a data mountain enclosure. |
| xinye / 新野 | 44,28 | plain->plain | 21/49 rough, 0/49 water | 2 | nanyang 31px | OK: center is passable and spacing/road checks are within thresholds. |
| xuchang / 许昌 | 54,24 | plain->plain | 6/49 rough, 4/49 water | 6 | guandu 27px | OK: plain center; rough terrain remains southwest, not surrounding the city. |
| xuzhou / 徐州 | 66,26 | hill->plain | 19/49 rough, 2/49 water | 7 | hefei 36px | OK: center is passable and spacing/road checks are within thresholds. |
...
| yiling / 夷陵 | 38,38 | mountain->plain | 12/49 rough, 7/49 water | 4 | shangyong 55px | ACCEPTED: rough or river-adjacent region matches the real western/southern terrain band. |
...
| yongan / 永安 | 29,45 | mountain->plain | 20/49 rough, 0/49 water | 3 | bazhong 85px | ACCEPTED: rough or river-adjacent region matches the real western/southern terrain band. |
...
| yuzhang / 豫章 | 66,50 | plain->plain | 3/49 rough, 7/49 water | 2 | changsha 91px | CHANGED: moved east toward the Poyang/Nanchang corridor; keeps Changsha spacing within limits. |
