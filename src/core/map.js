...
const TERRAIN_POLYS = [
  ...
  {type:'impassable', pts:'347,560 383,555 419,550 455,548 491,550 526,555 562,560 598,565 622,572 646,578 664,580 670,595 646,600 610,592 574,585 538,578 503,570 467,568 431,568 395,570 365,575 347,575'},
  // 大巴山（巴中-汉中之间的一段绝壁）
  ...
  // 武陵山麓（武陵周边，避免荆南山地城周围全为平原）
  {type:'hill', pts:'371,462 407,455 439,466 455,492 445,518 414,530 383,520 365,494'},
  ...
  // 长沙丘陵（长沙周围的江南丘陵地带）
  // 长沙北侧丘陵（保留江南丘陵，但让出长沙/湘水谷地）
  {type:'hill', pts:'473,505 509,500 546,506 562,520 548,532 511,528 477,522'},

  // ══════ 丘陵 (hill) ══════
  // 中原丘陵（许昌-洛阳之间的缓丘）
  {type:'hill', pts:'395,200 431,195 467,200 485,218 473,238 440,245 407,240 393,225 389,212'},
  // 伏牛山东麓/颍川丘陵（许昌西南-新野北侧，可通行丘陵）
  // 颍川西南丘陵（许昌城位留作平原）
  {type:'hill', pts:'420,276 452,264 478,270 490,290 470,306 436,298 416,288'},
  // 汝南北侧浅丘（许昌东南，不覆盖寿春/合肥）
  {type:'hill', pts:'500,295 532,288 562,294 574,312 558,328 526,330 498,318'},
  // 荆北丘陵（襄阳周围）
  ...
  // 江南丘陵（建业南方）
  {type:'hill', pts:'650,408 686,400 724,410 738,430 724,450 688,458 658,446 646,428'},
  // 陇西丘陵（天水东侧）
  ...
  {type:'impassable', pts:'52,220 72,210 96,218 118,238 136,270 148,310 150,350 147,390 142,430 134,460 120,470 102,455 82,430 62,400 52,365 45,330 42,292 45,260 48,235'},
  ...
  // 长沙-交州之间南部（五岭以南空白）
  {type:'impassable', pts:'377,660 431,657 479,660 526,667 568,677 596,690 596,714 467,712 371,714 371,697 377,677'},
  ...
  // 江东林区（会稽/吴郡南侧）
  {type:'forest', pts:'806,430 846,428 872,448 866,480 832,494 798,482 786,454'},
  // 闽北密林（武夷山东麓，福建沿海山林）
